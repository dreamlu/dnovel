...
// XPATH: 语法
var VideoSources = map[string]video.VideoSource{
	"beqegecc": {
		SourceName: "笔趣阁cc",
		SourceKey:  "beqegecc",
		...
		DetailVideoItemRule:          `//div[@id="main"]`,
		DetailVideoNameRule:          `//div[@id="info"]/h1`,
		DetailVideoAuthorRule:        `//div[@id="info"]/p[1]`,
		DetailVideoCoverRule:         `//div[@id="sidebar"]/div[@id="fmimg"]/img/@data-original]`,
		DetailVideoCategoryRule:      `//div[@class="con_top"]/a[2]`,
		DetailVideoDescriptionRule:   `//div[@id="intro"]/p[1]`,
		DetailVideoNewChapterRule:    `//div[@id="info"]/p[4]/a`,
		DetailVideoNewChapterUrlRule: `//div[@id="info"]/p[4]/a`,
		DetailVideoFirstChapterRule:  `//div[@id="list"]/dl/dd[1]/a`,
		DetailVideoFirstUrlRule:      `//div[@id="list"]/dl/dd[1]/a`,
	...
	"ibiquge": {
		...
		SearchURL:                "https://m.ibiquge.net/SearchVideo.php?keyword=%s",
		...
		DetailVideoNameRule:          `//div[@id="info"]/h1`,
		DetailVideoAuthorRule:        `//div[@id="info"]/p[1]`,
		DetailVideoCoverRule:         `//div[@id="fmimg"]/img/@src`,
		DetailVideoCategoryRule:      `//div[@class="con_top"]/a[2]`,
		DetailVideoDescriptionRule:   `//div[@id="intro"]`,
		DetailVideoNewChapterRule:    `//div[@id="info"]/p[4]/a`,
		DetailVideoNewChapterUrlRule: `//div[@id="info"]/p[4]/a`,
		DetailVideoFirstChapterRule:  `//div[@id="list"]/dl/dd[1]/a`,
		DetailVideoFirstUrlRule:      `//div[@id="list"]/dl/dd[13]/a`,
	...
	//
	//	DetailVideoItemRule:          `//div[@id="wrapper"]`,
	//	DetailVideoNameRule:          `//div[@id="info"]/h1`,
	//	DetailVideoAuthorRule:        `//div[@id="info"]/p[1]`,
	//	DetailVideoCoverRule:         `//div[@id="fmimg"]/img/@src`,
	//	DetailVideoCategoryRule:      `//div[@class="con_top"]/a[2]`,
