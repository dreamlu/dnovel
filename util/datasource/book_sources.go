...
var BookSources = map[int64]datamodels.BookSource{
	...
	2: {
		...
		ClassifyUrl: map[string][]string{
			cons.IntelRec:  {"https://www.biquge.com.cn/"},
			cons.Classify1: {"https://www.biquge.com.cn/xuanhuan"},
			cons.Classify2: {"https://www.biquge.com.cn/xiuzhen"},
			cons.Classify3: {"https://www.biquge.com.cn/kehuan"},
			cons.Classify4: {"https://www.biquge.com.cn/wangyou"},
			cons.Classify5: {"https://www.biquge.com.cn/lishi"},
			cons.Classify6: {"https://www.biquge.com.cn/dushi"},
		},
		ClassifyItemRule:   `//div[@id="newscontent"]/div[1]/ul/li`,
		ClassifyItemName:   `//span/a`,
		ClassifyItemAuthor: `//span[@class="s4"] or span[@class="s4"]`,
		...
		SearchURL:                "https://www.biquge.com.cn/search.php?q=%s",
